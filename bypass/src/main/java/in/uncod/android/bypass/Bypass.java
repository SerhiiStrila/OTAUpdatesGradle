...
public class Bypass {
    ...
    private final Map<Element, Integer> mOrderedListNumber
            = new ConcurrentHashMap<Element, Integer>();
    ...
    private static void setPrependedNewlineSpan(SpannableStringBuilder builder, int height) {
        builder.setSpan(new AbsoluteSizeSpan(height, true), 0, 1,
                Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
    }

    private native Document processMarkdown(String markdown);

    // The 'numberOfSiblings' parameters refers to the number of siblings within the parent,
    // including
    ...
    private CharSequence recurseElement(Element element,
        ...
        switch (type) {
            ...
            case BLOCK_QUOTE:
                ...
                setBlockSpan(builder,
                        new FancyQuoteSpan(mBlockQuoteLineWidth, mBlockQuoteLineIndent,
            ...
            case IMAGE:
                ...
                if (loadImageCallback != null && !TextUtils.isEmpty(url)) {
                    ...
                    setSpanWithPrependedNewline(builder,
                            new TouchableUrlSpan(url, textView.getLinkTextColors(),
                                    textView.getHighlightColor()));
        ...
        public Options setHeaderSizes(float[] headerSizes) {
            if (headerSizes == null) {
                ...
                throw new IllegalArgumentException(
                        "headerSizes must have 6 elements (h1 through h6)");
            }
