...
public interface Constants {
    ...
    String SD_CARD = Environment.getExternalStorageDirectory()
            .getAbsolutePath();
    String OTA_DOWNLOAD_DIR = Utils.doesPropExist(OTA_DOWNLOAD_LOC)
            ? Utils.getProp(OTA_DOWNLOAD_LOC)
            : "OTAUpdates";
    ...
    String MANIFEST_CHECK_BACKGROUND
            = "com.ota.update.MANIFEST_CHECK_BACKGROUND";
