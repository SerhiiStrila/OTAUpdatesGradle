...
public class AvailableActivity extends Activity implements Constants, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Utils.isLollipop()) {
            Toolbar toolbarBottom = findViewById(R.id.toolbar_available_bottom);
        ...
        if (Utils.isLollipop()) {
            mCheckMD5Button = findViewById(R.id.menu_available_check_md5);
    ...
    private void setupDialogs() {
        ...
        mNetworkDialog.setTitle(R.string.available_wrong_network_title)
                ...
                .setNeutralButton(R.string.settings, new OnClickListener() {
    ...
    private void setupChangeLog() {
        TextView changelogView = findViewById(R.id.tv_available_changelog_content);
        Bypass byPass = new Bypass(this, new Bypass.Options());
        String changeLogStr = RomUpdate.getChangelog(mContext);
        CharSequence string = byPass.markdownToSpannable(changeLogStr, changelogView, null);
    ...
    private void setupRomHut() {
        ...
        if (domainText != null) {
            TextView domainTextView = findViewById(R.id.tv_available_romhut);
    ...
    private void setupUpdateNameInfo() {
        ...
        TextView updateNameInfoText = findViewById(R.id.tv_available_update_name);
    ...
    private void setupMd5Info() {
        TextView md5Text = findViewById(R.id.tv_available_md5);
    ...
    public class MD5Check extends AsyncTask<Object, Boolean, Boolean> {
        ...
        protected Boolean doInBackground(Object... params) {
            ...
            String md5Remote = RomUpdate.getMd5(
                    mContext); // Remote MD5 form the manifest. This is what we expect it to be
            String md5Local = Tools.shell("md5sum " + file + " | cut -d ' ' -f 1",
                    false); // Run the check on our local file
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result) {
                Toast.makeText(mContext, mContext.getString(R.string.available_md5_ok),
                        Toast.LENGTH_LONG).show();
            } else {
                Toast.makeText(mContext, mContext.getString(R.string.available_md5_failed),
                        Toast.LENGTH_LONG).show();
            }
