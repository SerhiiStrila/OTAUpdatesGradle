...
public class AddonActivity extends Activity implements Constants {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (isLollipop) {
            Toolbar toolbar = findViewById(R.id.toolbar_addons);
    ...
    public static class AddonsArrayAdapter extends ArrayAdapter<Addon> {
        ...
        public static void updateButtons(int index, boolean finished) {
            ...
            final Button download = v.findViewById(R.id.download_button);
            final Button cancel = v.findViewById(R.id.cancel_button);
            final Button delete = v.findViewById(R.id.delete_button);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = LayoutInflater.from(getContext())
                        .inflate(R.layout.card_addons_list_item, parent, false);
            }

            TextView title = convertView.findViewById(R.id.title);
            TextView desc = convertView.findViewById(R.id.description);
            TextView updatedOn = convertView.findViewById(R.id.updatedOn);
            TextView filesize = convertView.findViewById(R.id.size);
            final Button download = convertView.findViewById(R.id.download_button);
            final Button cancel = convertView.findViewById(R.id.cancel_button);
            final Button delete = convertView.findViewById(R.id.delete_button);

            title.setText(item.getTitle());

            Bypass byPass = new Bypass(mContext, new Bypass.Options());
            String descriptionStr = item.getDesc();
            CharSequence string = byPass.markdownToSpannable(descriptionStr, desc, null);
            desc.setText(string);
            ...
            download.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    boolean isSettingWiFiOnly = Preferences.getNetworkType(mContext)
                            .equals(WIFI_ONLY);

                    if (isMobile && isSettingWiFiOnly) {
                        showNetworkDialog();
                    } else {
                        mDownloadAddon.startDownload(mContext, item.getDownloadLink(),
                                item.getTitle(), item.getId(), index);
        ...
        private void deleteConfirm(final File file, final Addon item) {
            ...
            deleteConfirm.setMessage(
                    mContext.getResources().getString(R.string.delete_confirm) + "\n\n"
                            + file.getName());
