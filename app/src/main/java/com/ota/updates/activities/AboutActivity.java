...
public class AboutActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView donateTitle = findViewById(R.id.about_tv_donate_title);
        TextView creditsTitle = findViewById(R.id.about_tv_credits_title);
        TextView changelogTitle = findViewById(R.id.about_tv_changelog_title);
        TextView creditsSummary = findViewById(R.id.about_tv_credits_summary);
        ...
        String creditsText =
                openHTML + "Matt Booth" + closeHTML + " - Anything not mentioned below" + newLine +
                        openHTML + "Roman Nurik" + closeHTML + " - Android Asset Studio Framework"
                        + newLine +
                        openHTML + "Jeff Gilfelt" + closeHTML
                        + " - Android Action Bar Style Generator" + newLine +
        ...
        TextView versionTitle = findViewById(R.id.about_tv_version_title);
        versionTitle.setTypeface(typeFace);

        TextView versionSummary = findViewById(R.id.about_tv_version_summary);
